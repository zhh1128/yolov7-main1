python detect.py --weights best.pt --conf 0.25 --img-size 640 --source inference/images/horses.jpg# Official YOLOv7
...
``` shell
# train p5 models
python train.py --workers 8 --batch-size 32 --data data/coco_my.yaml --img 640 640 --cfg cfg/training/yolov_my.yaml --name yolov7 --hyp data/hyp.scratch.p5.yaml
